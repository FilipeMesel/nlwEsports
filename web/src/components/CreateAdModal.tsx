...
export function CreateAdModal() {
    ...
    async function handleCreateAd(event: FormEvent) {
        event.preventDefault() //Vai prevenir o comportamento default do formulário que é redirecionar a tela.
            ...
            <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
              <form onSubmit={handleCreateAd} className='nt-8 flex flex-col gap-4'>
                ...
                <footer className='mt-4 flex justify-end gap-4'>
                  ...
                  <button 
                  type='submit'
                  className='bg-violet-500 px-5 h-12 rounded-md font-bold flex-items-center gap-3 hover:bg-violet-600'
                  >
